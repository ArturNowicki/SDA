...
public class ExercisesList {
    ...
    /**
     * L.1 Celem zadania jest uzupelnienie metody
    ...
    public void fill() {
        ...
        List<String> listTwo = ExercisesImpl.fillGeneric("hello", 5);
    ...
    /**
     * L.2 Celem zadania jest uzupelnienie metody ExercisesImpl.swap,
